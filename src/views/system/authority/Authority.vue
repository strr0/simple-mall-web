                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item prop="icon" label="图标">
                                <el-input v-model="authority.icon" style="width: 80%" disabled />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
            ...
            <el-dialog :title="title" :visible.sync="editModalVisible" width="60%">
                <el-form :model="authority" ref="authority" :rules="rules" label-position="right" label-width="20%">
                    <el-row>
                        ...
                        <el-col :span="12" v-show="!authority.isMenu">
                            <el-form-item prop="type" label="按钮类型">
                                <el-input v-model="authority.type" placeholder="请输入按钮类型"
                                    prefix-icon="el-icon-edit" style="width: 80%" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="12" v-show="!authority.isMenu">
                            <el-form-item prop="icon" label="图标">
                                <el-input v-model="authority.icon" placeholder="请输入图标"
                                    prefix-icon="el-icon-edit" style="width: 80%" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12" v-show="!authority.isMenu">
    ...
    methods: {
        ...
        save() {
            this.$refs.authority.validate(valid => {
                if(valid) {
                    ...
                    this.postRequest('/system/authority/save', this.authority).then(resp => {
                        if(resp && resp.success) {
                            this.$message({
                                message: '修改成功',
                                type: 'success'
        ...
        del() {
            ...
            this.$confirm('此操作将永久删除此项, 是否继续?', '提示', {
                ...
                this.deleteRequest('/system/authority/delete?id=' + this.currentRow.id).then((resp) => {
                    if (resp && resp.success) {
                        this.$message({
                            message: '删除成功',
                            type: 'success'
