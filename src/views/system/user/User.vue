                ...
                <el-form :model="user" label-position="right" label-width="80px">
                    <el-row>
                        <el-col :span="12">
                            <el-form-item prop="username" label="用户名">
                                <el-input type="text" v-model="user.username" style="width: 80%" disabled />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item prop="nickname" label="昵称">
                                <el-input type="text" v-model="user.nickname" style="width: 80%" disabled />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item prop="email" label="电子邮箱">
                                <el-input type="text" v-model="user.email" style="width: 80%" disabled />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="角色">
                                <el-select v-model="newRids" multiple style="width: 80%" disabled>
                    ...
                    <el-row>
                        <el-form-item prop="avatar" label="用户头像">
                            <el-input v-model="user.userface" style="width: 90%" disabled />
                        </el-form-item>
                    </el-row>
                    <el-row>
                        <el-form-item prop="remark" label="个人说明">
                            <el-input type="textarea" v-model="user.description" style="width: 90%" disabled />
                        </el-form-item>
                    </el-row>
                </el-form>
            </el-dialog>
        ...
        <div>
            <el-dialog :title="title" :visible.sync="editModalVisible" width="50%">
                <el-form :model="user" ref="user" :rules="rules" label-position="right" label-width="80px">
                    ...
                    <el-row>
                        <el-form-item prop="avatar" label="用户头像">
                            <el-input v-model="user.userface" placeholder="请上传用户头像" style="width: 90%" />
                        </el-form-item>
                    </el-row>
                    <el-row>
                        <el-form-item prop="remark" label="个人说明">
                            <el-input type="textarea" v-model="user.description" placeholder="请输入个人说明"
                                style="width: 90%" />
                        </el-form-item>
                    </el-row>
                </el-form>
...
export default {
    ...
    methods: {
        ...
        initUser() {
            this.loading = true
            let url = '/system/user/page?page=' + this.page + '&size=' + this.size
        ...
        initRole() {
            this.getRequest('/system/role/list')
            .then(resp => {
                if(resp && resp.success) {
        ...
        save() {
            this.$refs.user.validate(valid => {
                if(valid) {
                    ...
                    this.postRequest('/system/user/saveInfo', form).then(resp => {
                        if(resp && resp.success) {
                            this.$message({
                                message: '修改成功',
                                type: 'success'
        ...
        show() {
            ...
            this.getRequest('/system/user/listRelByUid?uid=' + this.currentRow.id).then(resp => {
                if(resp && resp.success) {
        ...
        del() {
            ...
            this.$confirm('此操作将永久删除此项, 是否继续?', '提示', {
                ...
                this.deleteRequest('/system/user/delete?id=' + this.currentRow.id).then((resp) => {
                    if (resp) {
                        this.$message({
                            message: '删除成功',
                            type: 'success'
